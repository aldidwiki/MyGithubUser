...
import com.aldidwikip.mygithubuser.presentation.ui.favorite.FavoriteActivity
        ...
        binding.apply {
            lifecycleScope.launch {
                lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
                    launch {
                        mainViewModel.getUsers.collect { dataState ->
                            when (dataState) {
                    ...
                    launch {
                        mainViewModel.getUserSearch.collect { dataState ->
                            when (dataState) {
                                is DataState.Success -> {
                                    progressBar.showLoading(false)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                mainViewModel.setUserKeyword(query ?: "")
